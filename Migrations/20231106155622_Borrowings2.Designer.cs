...
namespace Spinu_Iulian_Laborator2.Migrations
{
    ...
    [Migration("20231106155622_Borrowings2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Spinu_Iulian_Laborator2.Models.Borrowing", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Spinu_Iulian_Laborator2.Models.Member", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Spinu_Iulian_Laborator2.Models.Borrowing", b =>
                {
                    b.HasOne("Spinu_Iulian_Laborator2.Models.Book", "Book")
                        .WithOne("Borrowing")
                        .HasForeignKey("Spinu_Iulian_Laborator2.Models.Borrowing", "BookID");

                    b.HasOne("Spinu_Iulian_Laborator2.Models.Member", "Member")
                        .WithMany("Borrowings")
